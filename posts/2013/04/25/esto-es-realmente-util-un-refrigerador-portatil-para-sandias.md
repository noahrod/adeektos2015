---
title: "Esto es realmente útil: un refrigerador portátil para sandías."
date: 2013-04-25
author: Edgar Pelaez
...
Así que ahora no tienes porque preocuparte si se te olvidan los hielos, ya que con Tama-chan podrás mantener tus cervezas muertas- Tampoco hay que preocuparse por llevar pilas, ya que se conecta al encendedor de cigarros de tu auto. Joybond ha cuidado todo aspecto en su diseño, ya que ni siquiera necesitas cargarlo, debido a sus prácticas rueditas.

![image](http://sociorocketnewsen.files.wordpress.com/2013/04/tamachan-2.jpg?w=580&h=313)

También funciona como calentador, para que puedas mantener calientes tus[ bollos al vapor](http://es.wikipedia.org/wiki/Baozi). Así que ya sabes, este útil y práctico invento es lo que necesitas para facilitar tu vida diaria.
