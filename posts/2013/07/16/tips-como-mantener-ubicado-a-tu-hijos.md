---
title: "Tip: ¿Cómo mantener ubicado a tu hijo(a)(s)?"
date: 2013-07-16
...
Ser padre no es cosa fácil y menos en estos tiempos. Gracias a las redes móviles estamos todo el tiempo en contacto con los que queremos (y muchas veces con los que no) y también por ellas aquí en Adeektos te presentamos una serie de artefactos para que puedas tener un ojo al gato y otro al garabato con tus hijos.
...
**2. [Amber Alert GPS](http://www.amberalertgps.com/)**

![image: amber-alert-gps](http://adeektos.com/blog/wp-content/uploads/2013/07/amber-alert-gps.jpg)

Este dispositivo si fue diseñado específicamente pensando en los niños, además de hacer lo que todos suponemos, cuenta con un botón de SOS por si llega a necesitar atención inmediata.

**3. [PocketFinder](http://www.amberalertgps.com/)**

![image: PocketFinder-GPS](http://adeektos.com/blog/wp-content/uploads/2013/07/PocketFinder-GPS.jpg)

Este es el que más me gusta, porque además de tener Apps para el iOS y el Android, te permite revisar tu historia de navegación por 60 días. Es el que mejor ahorro de batería tiene, pues le puedes indicar cuando debe prenderse y apagarse.
